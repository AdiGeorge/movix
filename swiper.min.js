! function (e, t) {
        ...
        if (i)
            if ("string" == typeof i) {
                ...
                if (0 <= d.indexOf("<") && 0 <= d.indexOf(">")) {
                    ...
                    for (o = s || "#" !== i[0] || i.match(/[ .<>:~]/) ? (s || e).querySelectorAll(i.trim()) : [e.getElementById(i.trim().split("#")[1])], n = 0; n < o.length; n += 1) o[n] && r.push(o[n])
    ...
    var r = {
            ...
            function l(e) {
                ...
                if (t) {
                    ...
                    if (a.indexOf(e) < 0 && a.unshift(e), i(t).is(r)) n.apply(t, a);
                        ...
                        for (var s = i(t).parents(), o = 0; o < s.length; o += 1) i(s[o]).is(r) && n.apply(s[o], a)
                }
            }
        ...
        prepend: function (t) {
            ...
            for (i = 0; i < this.length; i += 1)
                if ("string" == typeof t) {
                    ...
                    for (r.innerHTML = t, s = r.childNodes.length - 1; 0 <= s; s -= 1) this[i].insertBefore(r.childNodes[s], this[i].childNodes[0])
                } else if (t instanceof a)
        ...
        parents: function (e) {
            for (var t = [], a = 0; a < this.length; a += 1)
                for (var r = this[a].parentNode; r;) e ? i(r).is(e) && t.push(r) : t.push(r), r = r.parentNode;
            return i(s(t))
        },
        closest: function (e) {
            var t = this;
        ...
        children: function (e) {
            for (var t = [], r = 0; r < this.length; r += 1)
                for (var n = this[r].childNodes, o = 0; o < n.length; o += 1) e ? 1 === n[o].nodeType && i(n[o]).is(e) && t.push(n[o]) : 1 === n[o].nodeType && t.push(n[o]);
            return new a(s(t))
        },
        remove: function () {
    ...
    var n, o, l, d, p = {
            ...
            getTranslate: function (e, a) {
                ...
                return t.WebKitCSSMatrix ? (6 < (s = n.transform || n.webkitTransform).split(",").length && (s = s.split(", ").map(function (e) {
                    return e.replace(",", ".")
                }).join(", ")), r = new t.WebKitCSSMatrix("none" === s ? "" : s)) : i = (r = n.MozTransform || n.OTransform || n.MsTransform || n.msTransform || n.transform || n.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","), "x" === a && (s = t.WebKitCSSMatrix ? r.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])), "y" === a && (s = t.WebKitCSSMatrix ? r.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])), s || 0
            },
    ...
    }, h.prototype.once = function (e, t, a) {
        var i = this;
        if ("function" != typeof t) return i;
    ...
    var f = {
            ...
            updateSlides: function () {
                ...
                if (void 0 !== s) {
                    ...
                    "string" == typeof y && 0 <= y.indexOf("%") && (y = parseFloat(y.replace("%", "")) / 100 * s), e.virtualSize = -y, r ? d.css({
                        ...
                        marginRight: "",
                        marginBottom: ""
                    }), 1 < a.slidesPerColumn && (S = Math.floor(u / a.slidesPerColumn) === u / e.params.slidesPerColumn ? u : Math.ceil(u / a.slidesPerColumn) * a.slidesPerColumn, "auto" !== a.slidesPerView && "row" === a.slidesPerColumnFill && (S = Math.max(S, a.slidesPerView * a.slidesPerColumn)));
                    for (var M, z = a.slidesPerColumn, P = S / z, k = Math.floor(u / a.slidesPerColumn), $ = 0; $ < u; $ += 1) {
                        C = 0;
                        var L = d.eq($);
                        if (1 < a.slidesPerColumn) {
                            var I = void 0,
                                D = void 0,
                                O = void 0;
                            "column" === a.slidesPerColumnFill ? (O = $ - (D = Math.floor($ / z)) * z, (k < D || D === k && O === z - 1) && z <= (O += 1) && (O = 0, D += 1), I = D + O * S / z, L.css({
                                "-webkit-box-ordinal-group": I,
                                "-moz-box-ordinal-group": I,
                                "-ms-flex-order": I,
                                "-webkit-order": I,
                                order: I
                            })) : D = $ - (O = Math.floor($ / P)) * P, L.css("margin-" + (e.isHorizontal() ? "top" : "left"), 0 !== O && a.spaceBetween && a.spaceBetween + "px").attr("data-swiper-column", D).attr("data-swiper-row", O)
                        }
                        if ("none" !== L.css("display")) {
                            if ("auto" === a.slidesPerView) {
                                var A = t.getComputedStyle(L[0], null),
                                    H = L[0].style.transform,
                                    N = L[0].style.webkitTransform;
                                if (H && (L[0].style.transform = "none"), N && (L[0].style.webkitTransform = "none"), a.roundLengths) C = e.isHorizontal() ? L.outerWidth(!0) : L.outerHeight(!0);
                                    ...
                                    C = F && "border-box" === F ? G + Y + V : G + B + X + Y + V
                                } else {
                                ...
                                H && (L[0].style.transform = H), N && (L[0].style.webkitTransform = N), a.roundLengths && (C = Math.floor(C))
                            } else C = (s - (a.slidesPerView - 1) * y) / a.slidesPerView, a.roundLengths && (C = Math.floor(C)), d[$] && (e.isHorizontal() ? d[$].style.width = C + "px" : d[$].style.height = C + "px");
                            d[$] && (d[$].swiperSlideSize = C), f.push(C), a.centeredSlides ? (x = x + C / 2 + T / 2 + y, 0 === T && 0 !== $ && (x = x - s / 2 - y), 0 === $ && (x = x - s / 2 - y), Math.abs(x) < .001 && (x = 0), a.roundLengths && (x = Math.floor(x)), E % a.slidesPerGroup == 0 && h.push(x), v.push(x)) : (a.roundLengths && (x = Math.floor(x)), E % a.slidesPerGroup == 0 && h.push(x), v.push(x), x = x + C + y), e.virtualSize += C + y, T = C, E += 1
                        }
                    }
                    if (e.virtualSize = Math.max(e.virtualSize, s) + g, r && n && ("slide" === a.effect || "coverflow" === a.effect) && i.css({
                            width: e.virtualSize + a.spaceBetween + "px"
                        }), c.flexbox && !a.setWrapperSize || (e.isHorizontal() ? i.css({
                            width: e.virtualSize + a.spaceBetween + "px"
                        }) : i.css({
                        ...
                        for (var _ = 0; _ < h.length; _ += 1) {
                            var Z = h[_];
                            a.roundLengths && (Z = Math.floor(Z)), h[_] < e.virtualSize + h[0] && M.push(Z)
                        }
                        h = M
                    }
                    if (!a.centeredSlides) {
                        ...
                        for (var Q = 0; Q < h.length; Q += 1) {
                            var J = h[Q];
                            a.roundLengths && (J = Math.floor(J)), h[Q] <= e.virtualSize - s && M.push(J)
                        }
                        h = M, 1 < Math.floor(e.virtualSize - s) - Math.floor(h[h.length - 1]) && h.push(e.virtualSize - s)
                    }
                    if (0 === h.length && (h = [0]), 0 !== a.spaceBetween && (e.isHorizontal() ? r ? d.css({
                            marginLeft: y + "px"
                        }) : d.css({
                            marginRight: y + "px"
                        }) : d.css({
                    ...
                    p.extend(e, {
                        ...
                        slidesGrid: v,
                        slidesSizesGrid: f
                    }), u !== l && e.emit("slidesLengthChange"), h.length !== b && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), v.length !== w && e.emit("slidesGridLengthChange"), (a.watchSlidesProgress || a.watchSlidesVisibility) && e.updateSlidesOffset()
                }
            },
        ...
        g = {
            ...
            slideToClickedSlide: function () {
                ...
                if (a.loop) {
                    ...
                    e = parseInt(i(t.clickedSlide).attr("data-swiper-slide-index"), 10), a.centeredSlides ? n < t.loopedSlides - r / 2 || n > t.slides.length - t.loopedSlides + r / 2 ? (t.loopFix(), n = s.children("." + a.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + a.slideDuplicateClass + ")").eq(0).index(), p.nextTick(function () {
                        t.slideTo(n)
                    })) : t.slideTo(n) : n > t.slides.length - r ? (t.loopFix(), n = s.children("." + a.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + a.slideDuplicateClass + ")").eq(0).index(), p.nextTick(function () {
                        t.slideTo(n)
                    })) : t.slideTo(n)
                } else t.slideTo(n)
            }
        ...
        b = {
            loopCreate: function () {
                ...
                r.each(function (e, a) {
                    var s = i(a);
                    e < t.loopedSlides && p.push(a), e < r.length && e >= r.length - t.loopedSlides && d.push(a), s.attr("data-swiper-slide-index", e)
                });
        ...
        y = {
            ...
            prependSlide: function (e) {
                ...
                a.loop && t.loopCreate(), a.observer && c.observer || t.update(), t.slideTo(r, 0, !1)
            },
            addSlide: function (e, t) {
                ...
                if (e <= 0) a.prependSlide(t);
                    ...
                    s.loop && a.loopCreate(), s.observer && c.observer || a.update(), s.loop ? a.slideTo(o + a.loopedSlides, 0, !1) : a.slideTo(o, 0, !1)
                }
            },
            removeSlide: function (e) {
                ...
                a.loop && t.loopCreate(), a.observer && c.observer || t.update(), a.loop ? t.slideTo(n + t.loopedSlides, 0, !1) : t.slideTo(n, 0, !1)
            },
        ...
        x = function () {
            var a = t.navigator.userAgent,
                ...
                s = a.match(/(Windows Phone);?[\s\/]+([\d.]+)?/),
                r = a.match(/(Android);?[\s\/]+([\d.]+)?/),
                n = a.match(/(iPad).*OS\s([\d_]+)/),
                o = a.match(/(iPod)(.*OS\s([\d_]+))?/),
                l = !n && a.match(/(iPhone\sOS|iOS)\s([\d_]+)/);
    ...
    var E = {
        ...
        S = {
            ...
            events: {
                attachEvents: function () {
                    ...
                    a.onTouchStart = function (a) {
                        ...
                        if (!s.animating || !n.preventInteractionOnTransition) {
                            ...
                            if (l.originalEvent && (l = l.originalEvent), r.isTouchEvent = "touchstart" === l.type, (r.isTouchEvent || !("which" in l) || 3 !== l.which) && !(!r.isTouchEvent && "button" in l && 0 < l.button || r.isTouched && r.isMoved))
                                if (n.noSwiping && i(l.target).closest(n.noSwipingSelector ? n.noSwipingSelector : "." + n.noSwipingClass)[0]) s.allowClick = !0;
                                ...
                                if (!u || !(d <= h || d >= t.screen.width - h)) {
                                    if (p.extend(r, {
                                            ...
                                            isScrolling: void 0,
                                            startMoving: void 0
                                        }), o.startX = d, o.startY = c, r.touchStartTime = p.now(), s.allowClick = !0, s.updateSize(), s.swipeDirection = void 0, 0 < n.threshold && (r.allowThresholdMove = !1), "touchstart" !== l.type) {
                                        var v = !0;
                                        i(l.target).is(r.formElements) && (v = !1), e.activeElement && i(e.activeElement).is(r.formElements) && e.activeElement !== l.target && e.activeElement.blur();
                                        var f = v && s.allowTouchMove && n.touchStartPreventDefault;
                        ...
                        if (l.originalEvent && (l = l.originalEvent), s.isTouched) {
                            if (!s.isTouchEvent || "mousemove" !== l.type) {
                                ...
                                if (!a.allowTouchMove) return a.allowClick = !1, void(s.isTouched && (p.extend(n, {
                                    startX: d,
                                    startY: c,
                                    currentX: d,
                                    currentY: c
                                ...
                                if (s.isTouchEvent && r.touchReleaseOnEdges && !r.loop)
                                    if (a.isVertical()) {
                                        if (c < n.startY && a.translate <= a.maxTranslate() || c > n.startY && a.translate >= a.minTranslate()) return s.isTouched = !1, void(s.isMoved = !1)
                                    } else if (d < n.startX && a.translate <= a.maxTranslate() || d > n.startX && a.translate >= a.minTranslate()) return;
                                if (s.isTouchEvent && e.activeElement && l.target === e.activeElement && i(l.target).is(s.formElements)) return s.isMoved = !0, void(a.allowClick = !1);
                                if (s.allowTouchCallbacks && a.emit("touchMove", l), !(l.targetTouches && 1 < l.targetTouches.length)) {
                                    ...
                                    if (!(a.params.threshold && Math.sqrt(Math.pow(h, 2) + Math.pow(v, 2)) < a.params.threshold))
                                        if (void 0 === s.isScrolling && (a.isHorizontal() && n.currentY === n.startY || a.isVertical() && n.currentX === n.startX ? s.isScrolling = !1 : 25 <= h * h + v * v && (u = 180 * Math.atan2(Math.abs(v), Math.abs(h)) / Math.PI, s.isScrolling = a.isHorizontal() ? u > r.touchAngle : 90 - u > r.touchAngle)), s.isScrolling && a.emit("touchMoveOpposite", l), void 0 === s.startMoving && (n.currentX === n.startX && n.currentY === n.startY || (s.startMoving = !0)), s.isScrolling) s.isTouched = !1;
                                        else if (s.startMoving) {
                                        a.allowClick = !1, l.preventDefault(), r.touchMoveStopPropagation && !r.nested && l.stopPropagation(), s.isMoved || (r.loop && a.loopFix(), s.startTranslate = a.getTranslate(), a.setTransition(0), a.animating && a.$wrapperEl.trigger("webkitTransitionEnd transitionend"), s.allowMomentumBounce = !1, !r.grabCursor || !0 !== a.allowSlideNext && !0 !== a.allowSlidePrev || a.setGrabCursor(!0), a.emit("sliderFirstMove", l)), a.emit("sliderMove", l), s.isMoved = !0;
                                        var f = a.isHorizontal() ? h : v;
                                        n.diff = f, f *= r.touchRatio, o && (f = -f), a.swipeDirection = 0 < f ? "prev" : "next", s.currentTranslate = f + s.startTranslate;
                                        var m = !0,
                                            g = r.resistanceRatio;
                                        if (r.touchReleaseOnEdges && (g = 0), 0 < f && s.currentTranslate > a.minTranslate() ? (m = !1, r.resistance && (s.currentTranslate = a.minTranslate() - 1 + Math.pow(-a.minTranslate() + s.startTranslate + f, g))) : f < 0 && s.currentTranslate < a.maxTranslate() && (m = !1, r.resistance && (s.currentTranslate = a.maxTranslate() + 1 - Math.pow(a.maxTranslate() - s.startTranslate - f, g))), m && (l.preventedByNestedSwiper = !0), !a.allowSlideNext && "next" === a.swipeDirection && s.currentTranslate < s.startTranslate && (s.currentTranslate = s.startTranslate), !a.allowSlidePrev && "prev" === a.swipeDirection && s.currentTranslate > s.startTranslate && (s.currentTranslate = s.startTranslate), 0 < r.threshold) {
                                            if (!(Math.abs(f) > r.threshold || s.allowThresholdMove)) return void(s.currentTranslate = s.startTranslate);
                                        ...
                                        r.followFinger && ((r.freeMode || r.watchSlidesProgress || r.watchSlidesVisibility) && (a.updateActiveIndex(), a.updateSlidesClasses()), r.freeMode && (0 === s.velocities.length && s.velocities.push({
                        ...
                        if (a.isTouched = !1, a.isMoved = !1, a.startMoving = !1, c = i.followFinger ? r ? t.translate : -t.translate : -a.currentTranslate, i.freeMode) {
                            ...
                            for (var z = 0, P = t.slidesSizesGrid[0], k = 0; k < o.length; k += i.slidesPerGroup) void 0 !== o[k + i.slidesPerGroup] ? c >= o[k] && c < o[k + i.slidesPerGroup] && (P = o[(z = k) + i.slidesPerGroup] - o[k]) : c >= o[k] && (z = k, P = o[o.length - 1] - o[o.length - 2]);
                            var $ = (c - o[z]) / P;
                            if (h > i.longSwipesMs) {
                                if (!i.longSwipes) return void t.slideTo(t.activeIndex);
                                "next" === t.swipeDirection && ($ >= i.longSwipesRatio ? t.slideTo(z + i.slidesPerGroup) : t.slideTo(z)), "prev" === t.swipeDirection && ($ > 1 - i.longSwipesRatio ? t.slideTo(z + i.slidesPerGroup) : t.slideTo(z))
                            } else {
                                if (!i.shortSwipes) return void t.slideTo(t.activeIndex);
                                "next" === t.swipeDirection && t.slideTo(z + i.slidesPerGroup), "prev" === t.swipeDirection && t.slideTo(z)
                            }
                        }
                    ...
                    if (c.touch || !c.pointerEvents && !c.prefixedPointerEvents) {
                        if (c.touch) {
                            var u = !("touchstart" !== r.start || !c.passiveListener || !s.passiveListeners) && {
                                passive: !0,
                                capture: !1
                            };
                            l.addEventListener(r.start, a.onTouchStart, u), l.addEventListener(r.move, a.onTouchMove, c.passiveListener ? {
                                passive: !1,
                                capture: d
                            } : d), l.addEventListener(r.end, a.onTouchEnd, u)
                        }(s.simulateTouch && !x.ios && !x.android || s.simulateTouch && !c.touch && x.ios) && (l.addEventListener("mousedown", a.onTouchStart, !1), e.addEventListener("mousemove", a.onTouchMove, d), e.addEventListener("mouseup", a.onTouchEnd, !1))
                    } else l.addEventListener(r.start, a.onTouchStart, !1), e.addEventListener(r.move, a.onTouchMove, d), e.addEventListener(r.end, a.onTouchEnd, !1);
                    (s.preventClicks || s.preventClicksPropagation) && l.addEventListener("click", a.onClick, !0), a.on(x.ios || x.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", T, !0)
                },
                detachEvents: function () {
                    ...
                    if (c.touch || !c.pointerEvents && !c.prefixedPointerEvents) {
                        ...
                        }(a.simulateTouch && !x.ios && !x.android || a.simulateTouch && !c.touch && x.ios) && (n.removeEventListener("mousedown", t.onTouchStart, !1), e.removeEventListener("mousemove", t.onTouchMove, o), e.removeEventListener("mouseup", t.onTouchEnd, !1))
                    ...
                    (a.preventClicks || a.preventClicksPropagation) && n.removeEventListener("click", t.onClick, !0), t.off(x.ios || x.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", T)
                }
            },
            breakpoints: {
                setBreakpoint: function () {
                    ...
                    if (r && (!r || 0 !== Object.keys(r).length)) {
                        ...
                        if (n && e.currentBreakpoint !== n) {
                            ...
                            d && a && e.changeDirection(), p.extend(e.params, l), p.extend(e, {
                                allowTouchMove: e.params.allowTouchMove,
                                allowSlideNext: e.params.allowSlideNext,
                                allowSlidePrev: e.params.allowSlidePrev
                            }), e.currentBreakpoint = n, c && a && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - i + e.loopedSlides, 0, !1)), e.emit("breakpoint", l)
                        }
                    }
                },
                getBreakpoint: function (e) {
                    if (e) {
                        ...
                        for (var s = 0; s < i.length; s += 1) {
                            var r = i[s];
                            this.params.breakpointsInverse ? r <= t.innerWidth && (a = r) : r >= t.innerWidth && !a && (a = r)
                        }
                        return a || "max"
                    }
                }
            ...
            classes: {
                addClasses: function () {
                    var e = this.classNames,
                        ...
                        i = this.$el,
                        s = [];
                    s.push("initialized"), s.push(t.direction), t.freeMode && s.push("free-mode"), c.flexbox || s.push("no-flexbox"), t.autoHeight && s.push("autoheight"), a && s.push("rtl"), 1 < t.slidesPerColumn && s.push("multirow"), x.android && s.push("android"), x.ios && s.push("ios"), (u.isIE || u.isEdge) && (c.pointerEvents || c.prefixedPointerEvents) && s.push("wp8-" + t.direction), s.forEach(function (a) {
            ...
            images: {
                loadImage: function (e, a, i, s, r, n) {
                    ...
                    e.complete && r ? l() : a ? ((o = new t.Image).onload = l, o.onerror = l, s && (o.sizes = s), i && (o.srcset = i), a && (o.src = a)) : l()
                },
        ...
        M = function (e) {
            function t() {
                ...
                1 === n.length && n[0].constructor && n[0].constructor === Object ? r = n[0] : (s = (a = n)[0], r = a[1]), r || (r = {}), r = p.extend({}, r), s && !r.el && (r.el = s), e.call(this, r), Object.keys(S).forEach(function (e) {
                    Object.keys(S[e]).forEach(function (a) {
                        t.prototype[a] || (t.prototype[a] = S[e][a])
                    })
                });
                var l = this;
                ...
                var d = p.extend({}, E);
                l.useModulesParams(d), l.params = p.extend({}, d, C, r), l.originalParams = p.extend({}, l.params), l.passedParams = p.extend({}, r);
                ...
                if (s = u[0]) {
                    ...
                    var v, f, m = u.children("." + l.params.wrapperClass);
                    return p.extend(l, {
                        $el: u,
                        el: s,
                        $wrapperEl: m,
                        ...
                        touchEvents: (v = ["touchstart", "touchmove", "touchend"], f = ["mousedown", "mousemove", "mouseup"], c.pointerEvents ? f = ["pointerdown", "pointermove", "pointerup"] : c.prefixedPointerEvents && (f = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), l.touchEventsTouch = {
                            start: v[0],
                            move: v[1],
                            end: v[2]
        ...
        D = {
            update: function (e) {
                ...
                if (e) t.$wrapperEl.find("." + t.params.slideClass).remove();
                    ...
                    for (var z = c; z <= u; z += 1)(z < x || T < z) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + z + '"]').remove();
            ...
            renderSlide: function (e, t) {
                ...
                return r.attr("data-swiper-slide-index") || r.attr("data-swiper-slide-index", t), s.cache && (a.virtual.cache[t] = r), r
            },
            appendSlide: function (e) {
                if ("object" == typeof e && "length" in e)
        ...
        N = {
            ...
            enable: function () {
                ...
                var t = e.$el;
                return "container" !== e.params.mousewheel.eventsTarged && (t = i(e.params.mousewheel.eventsTarged)), t.on("mouseenter", e.mousewheel.handleMouseEnter), t.on("mouseleave", e.mousewheel.handleMouseLeave), t.on(N.event, e.mousewheel.handle), e.mousewheel.enabled = !0
            },
            disable: function () {
                var e = this;
                if (!N.event) return !1;
                if (!e.mousewheel.enabled) return !1;
                var t = e.$el;
                return "container" !== e.params.mousewheel.eventsTarged && (t = i(e.params.mousewheel.eventsTarged)), t.off(N.event, e.mousewheel.handle), !(e.mousewheel.enabled = !1)
            }
        },
        G = {
            update: function () {
            ...
            init: function () {
                ...
                (s.nextEl || s.prevEl) && (s.nextEl && (e = i(s.nextEl), a.params.uniqueNavElements && "string" == typeof s.nextEl && 1 < e.length && 1 === a.$el.find(s.nextEl).length && (e = a.$el.find(s.nextEl))), s.prevEl && (t = i(s.prevEl), a.params.uniqueNavElements && "string" == typeof s.prevEl && 1 < t.length && 1 === a.$el.find(s.prevEl).length && (t = a.$el.find(s.prevEl))), e && 0 < e.length && e.on("click", a.navigation.onNextClick), t && 0 < t.length && t.on("click", a.navigation.onPrevClick), p.extend(a.navigation, {
                    $nextEl: e,
                    nextEl: e && e[0],
                    $prevEl: t,
                    prevEl: t && t[0]
        ...
        B = {
            update: function () {
                ...
                if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                    ...
                    if (e.params.loop ? ((s = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)) > r - 1 - 2 * e.loopedSlides && (s -= r - 2 * e.loopedSlides), o - 1 < s && (s -= o), s < 0 && "bullets" !== e.params.paginationType && (s = o + s)) : s = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === a.type && e.pagination.bullets && 0 < e.pagination.bullets.length) {
                        var l, d, p, c = e.pagination.bullets;
                        if (a.dynamicBullets && (e.pagination.bulletSize = c.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), n.css(e.isHorizontal() ? "width" : "height", e.pagination.bulletSize * (a.dynamicMainBullets + 4) + "px"), 1 < a.dynamicMainBullets && void 0 !== e.previousIndex && (e.pagination.dynamicBulletIndex += s - e.previousIndex, e.pagination.dynamicBulletIndex > a.dynamicMainBullets - 1 ? e.pagination.dynamicBulletIndex = a.dynamicMainBullets - 1 : e.pagination.dynamicBulletIndex < 0 && (e.pagination.dynamicBulletIndex = 0)), l = s - e.pagination.dynamicBulletIndex, p = ((d = l + (Math.min(c.length, a.dynamicMainBullets) - 1)) + l) / 2), c.removeClass(a.bulletActiveClass + " " + a.bulletActiveClass + "-next " + a.bulletActiveClass + "-next-next " + a.bulletActiveClass + "-prev " + a.bulletActiveClass + "-prev-prev " + a.bulletActiveClass + "-main"), 1 < n.length) c.each(function (e, t) {
                            var r = i(t),
                                n = r.index();
                            n === s && r.addClass(a.bulletActiveClass), a.dynamicBullets && (l <= n && n <= d && r.addClass(a.bulletActiveClass + "-main"), n === l && r.prev().addClass(a.bulletActiveClass + "-prev").prev().addClass(a.bulletActiveClass + "-prev-prev"), n === d && r.next().addClass(a.bulletActiveClass + "-next").next().addClass(a.bulletActiveClass + "-next-next"))
                        });
                    ...
                    if ("fraction" === a.type && (n.find("." + a.currentClass).text(a.formatFractionCurrent(s + 1)), n.find("." + a.totalClass).text(a.formatFractionTotal(o))), "progressbar" === a.type) {
                        var b;
                    ...
                    "custom" === a.type && a.renderCustom ? (n.html(a.renderCustom(e, s + 1, o)), e.emit("paginationRender", e, n[0])) : e.emit("paginationUpdate", e, n[0]), n[e.params.watchOverflow && e.isLocked ? "addClass" : "removeClass"](a.lockClass)
                }
            },
            render: function () {
                var e = this,
        ...
        X = {
            ...
            updateSize: function () {
                ...
                if (e.params.scrollbar.el && e.scrollbar.el) {
                    ...
                    var s, r = e.isHorizontal() ? i[0].offsetWidth : i[0].offsetHeight,
                        ...
                        o = n * (r / e.size);
                    s = "auto" === e.params.scrollbar.dragSize ? r * n : parseInt(e.params.scrollbar.dragSize, 10), e.isHorizontal() ? a[0].style.width = s + "px" : a[0].style.height = s + "px", i[0].style.display = 1 <= n ? "none" : "", e.params.scrollbar.hide && (i[0].style.opacity = 0), p.extend(t, {
                        trackSize: r,
                        divider: n,
                        moveDivider: o,
                        dragSize: s
            ...
            enableDraggable: function () {
                ...
                if (t.params.scrollbar.el) {
                    ...
                    c.touch ? (n.addEventListener(i.start, t.scrollbar.onDragStart, o), n.addEventListener(i.move, t.scrollbar.onDragMove, o), n.addEventListener(i.end, t.scrollbar.onDragEnd, l)) : (n.addEventListener(s.start, t.scrollbar.onDragStart, o), e.addEventListener(s.move, t.scrollbar.onDragMove, o), e.addEventListener(s.end, t.scrollbar.onDragEnd, l))
                }
            },
            disableDraggable: function () {
                ...
                if (t.params.scrollbar.el) {
                    ...
                    c.touch ? (n.removeEventListener(i.start, t.scrollbar.onDragStart, o), n.removeEventListener(i.move, t.scrollbar.onDragMove, o), n.removeEventListener(i.end, t.scrollbar.onDragEnd, l)) : (n.removeEventListener(s.start, t.scrollbar.onDragStart, o), e.removeEventListener(s.move, t.scrollbar.onDragMove, o), e.removeEventListener(s.end, t.scrollbar.onDragEnd, l))
                }
            },
            init: function () {
                var e = this;
                if (e.params.scrollbar.el) {
                    var t = e.scrollbar,
                        ...
                        r = i(s.el);
                    e.params.uniqueNavElements && "string" == typeof s.el && 1 < r.length && 1 === a.find(s.el).length && (r = a.find(s.el));
                    var n = r.find("." + e.params.scrollbar.dragClass);
                    0 === n.length && (n = i('<div class="' + e.params.scrollbar.dragClass + '"></div>'), r.append(n)), p.extend(t, {
                        $el: r,
                        el: r[0],
                        $dragEl: n,
                        dragEl: n[0]
        ...
        Y = {
            ...
            setTranslate: function () {
                ...
                t.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function (t, a) {
                    ...
                    var n = a.progress;
                    1 < e.params.slidesPerGroup && "auto" !== e.params.slidesPerView && (n += Math.ceil(t / 2) - s * (r.length - 1)), n = Math.min(Math.max(n, -1), 1), i(a).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function (t, a) {
        ...
        V = {
            ...
            onGestureStart: function (e) {
                ...
                if (s.fakeGestureTouched = !1, s.fakeGestureMoved = !1, !c.gestures) {
                    ...
                    s.fakeGestureTouched = !0, r.scaleStart = V.getDistanceBetweenTouches(e)
                }
            ...
            onGestureChange: function (e) {
                ...
                i.$imageEl && 0 !== i.$imageEl.length && (a.scale = c.gestures ? e.scale * a.currentScale : i.scaleMove / i.scaleStart * a.currentScale, a.scale > i.maxRatio && (a.scale = i.maxRatio - 1 + Math.pow(a.scale - i.maxRatio + 1, .5)), a.scale < t.minRatio && (a.scale = t.minRatio + 1 - Math.pow(t.minRatio - a.scale + 1, .5)), i.$imageEl.transform("translate3d(0,0,0) scale(" + a.scale + ")"))
            },
            ...
            in: function (e) {
                var t, a, s, r, n, o, l, d, p, c, u, h, v, f, m, g, b = this,
                    w = b.zoom,
                    y = b.params.zoom,
                    x = w.gesture,
                    T = w.image;
                    ...
                    !r.hasClass(s.elementClass) || r.hasClass(s.loadedClass) || r.hasClass(s.loadingClass) || (n = n.add(r[0])), 0 !== n.length && n.each(function (e, n) {
                        ...
                        a.loadImage(o[0], d || l, p, c, !1, function () {
                            if (null != a && a && (!a || a.params) && !a.destroyed) {
                                if (l ? (o.css("background-image", 'url("' + l + '")'), o.removeAttr("data-background")) : (p && (o.attr("srcset", p), o.removeAttr("data-srcset")), c && (o.attr("sizes", c), o.removeAttr("data-sizes")), d && (o.attr("src", d), o.removeAttr("data-src"))), o.addClass(s.loadedClass).removeClass(s.loadingClass), r.find("." + s.preloaderClass).remove(), a.params.loop && t) {
        ...
        R = {
            ...
            setTranslate: function (e, t) {
                ...
                if (Array.isArray(r))
                    for (var o = 0; o < r.length; o += 1) r[o] !== t && r[o] instanceof M && n(r[o]);
            ...
            setTransition: function (e, t) {
                ...
                if (Array.isArray(s))
                    for (a = 0; a < s.length; a += 1) s[a] !== t && s[a] instanceof M && r(s[a]);
        ...
        W = {
            init: function () {
                ...
                if (e.params.history) {
                    ...
                    var a = e.history;
                    a.initialized = !0, a.paths = W.getPathValues(), (a.paths.key || a.paths.value) && (a.scrollToSlide(0, a.paths.value, e.params.runCallbacksOnInit), e.params.history.replaceState || t.addEventListener("popstate", e.history.setHistoryPopState))
                }
            },
            destroy: function () {
        ...
        j = {
            ...
            setHash: function () {
                ...
                if (a.hashNavigation.initialized && a.params.hashNavigation.enabled)
                    if (a.params.hashNavigation.replaceState && t.history && t.history.replaceState) t.history.replaceState(null, null, "#" + a.slides.eq(a.activeIndex).attr("data-hash") || "");
                    else {
        ...
        _ = {
            setTranslate: function () {
                ...
                for (var f = 0; f < r.length; f += 1) {
                    ...
                    if (y <= 1 && -1 < y && (v = 90 * g + 90 * y, l && (v = 90 * -g - 90 * y)), m.transform(S), p.slideShadows) {
                        ...
                        0 === C.length && (C = i('<div class="swiper-slide-shadow-' + (c ? "left" : "top") + '"></div>'), m.append(C)), 0 === M.length && (M = i('<div class="swiper-slide-shadow-' + (c ? "right" : "bottom") + '"></div>'), m.append(M)), C.length && (C[0].style.opacity = Math.max(-y, 0)), M.length && (M[0].style.opacity = Math.max(y, 0))
                    }
                }
                if (s.css({
                    ...
                    if (c) e.transform("translate3d(0px, " + (n / 2 + p.shadowOffset) + "px, " + -n / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + p.shadowScale + ")");
                        ...
                        var z = Math.abs(v) - 90 * Math.floor(Math.abs(v) / 90),
                            P = 1.5 - (Math.sin(2 * z * Math.PI / 360) / 2 + Math.cos(2 * z * Math.PI / 360) / 2),
                            k = p.shadowScale,
                            $ = p.shadowScale / P,
                            L = p.shadowOffset;
                        e.transform("scale3d(" + k + ", 1, " + $ + ") translate3d(0px, " + (o / 2 + L) + "px, " + -o / 2 / $ + "px) rotateX(-90deg)")
                    } var I = u.isSafari || u.isUiWebView ? -d / 2 : 0;
                s.transform("translate3d(0px,0," + I + "px) rotateX(" + (t.isHorizontal() ? 0 : v) + "deg) rotateY(" + (t.isHorizontal() ? -v : 0) + "deg)")
            },
            setTransition: function (e) {
                var t = this.$el;
            ...
            setTranslate: function () {
                for (var e = this, t = e.slides, a = e.rtlTranslate, s = 0; s < t.length; s += 1) {
                    ...
                    if (e.isHorizontal() ? a && (o = -o) : (p = d, l = -o, o = d = 0), r[0].style.zIndex = -Math.abs(Math.round(n)) + t.length, e.params.flipEffect.slideShadows) {
                        ...
                        0 === c.length && (c = i('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "left" : "top") + '"></div>'), r.append(c)), 0 === u.length && (u = i('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "right" : "bottom") + '"></div>'), r.append(u)), c.length && (c[0].style.opacity = Math.max(-n, 0)), u.length && (u[0].style.opacity = Math.max(n, 0))
                    }
        ...
        Q = {
            setTranslate: function () {
                for (var e = this, t = e.width, a = e.height, s = e.slides, r = e.$wrapperEl, n = e.slidesSizesGrid, o = e.params.coverflowEffect, l = e.isHorizontal(), d = e.translate, p = l ? t / 2 - d : a / 2 - d, u = l ? o.rotate : -o.rotate, h = o.depth, v = 0, f = s.length; v < f; v += 1) {
                    var m = s.eq(v),
                        g = n[v],
                    ...
                    if (m.transform(S), m[0].style.zIndex = 1 - Math.abs(Math.round(b)), o.slideShadows) {
                        ...
                        0 === C.length && (C = i('<div class="swiper-slide-shadow-' + (l ? "left" : "top") + '"></div>'), m.append(C)), 0 === M.length && (M = i('<div class="swiper-slide-shadow-' + (l ? "right" : "bottom") + '"></div>'), m.append(M)), C.length && (C[0].style.opacity = 0 < b ? b : 0), M.length && (M[0].style.opacity = 0 < -b ? -b : 0)
                    }
            ...
            onThumbClick: function () {
                ...
                if (t) {
                    ...
                    if (!(s && i(s).hasClass(e.params.thumbs.slideThumbActiveClass) || null == a)) {
                        var r;
                        if (r = t.params.loop ? parseInt(i(t.clickedSlide).attr("data-swiper-slide-index"), 10) : a, e.params.loop) {
                            var n = e.activeIndex;
                            ...
                            var o = e.slides.eq(n).prevAll('[data-swiper-slide-index="' + r + '"]').eq(0).index(),
                                l = e.slides.eq(n).nextAll('[data-swiper-slide-index="' + r + '"]').eq(0).index();
            ...
            on: {
                ...
                click: function (e) {
                    var t, a = this,
                        ...
                        r = s.$nextEl,
                        n = s.$prevEl;
                    !a.params.navigation.hideOnClick || i(e.target).is(n) || i(e.target).is(r) || (r ? t = r.hasClass(a.params.navigation.hiddenClass) : n && (t = n.hasClass(a.params.navigation.hiddenClass)), !0 === t ? a.emit("navigationShow", a) : a.emit("navigationHide", a), r && r.toggleClass(a.params.navigation.hiddenClass), n && n.toggleClass(a.params.navigation.hiddenClass))
                }
            }
        }, {
            name: "pagination",
    ...
    return void 0 === M.use && (M.use = M.Class.use, M.installModule = M.Class.installModule), M.use(ee), M
});