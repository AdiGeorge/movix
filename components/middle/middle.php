    ...
    <main class="container">
        <div id="home" class="subpage">
            ...
            <!-- <div id="animation">Text</div> -->
                <video id="movieDisplay" src="/movix/video/movie3Queen.mp4" autoplay loop muted></video>
                ...
                <div class="movies-container">
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            ...
                            <img class="swiper-slide" src="images/movie4.png" alt="movie1">
                            <img class="swiper-slide" src="images/movie5.png" alt="movie2">
                            <img class="swiper-slide" src="images/movie6.png" alt="movie3">
                            <img class="swiper-slide" src="images/movie7.png" alt="movie1">
                            <img class="swiper-slide" src="images/movie8.png" alt="movie2">
                            <img class="swiper-slide" src="images/movie9.png" alt="movie3">
                        </div>
            ...
            <div>
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <img class="swiper-slide myBtn9" src="images/movie9.png" alt="movie1">
                        <img class="swiper-slide myBtn5" src="images/movie5.png" alt="movie2">
                        <img class="swiper-slide myBtn7" src="images/movie7.png" alt="movie3">
            ...
            <div>
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <img class="swiper-slide myBtn8" src="images/movie8.png" alt="movie1">
                        <img class="swiper-slide myBtn6" src="images/movie6.png" alt="movie2">
                        <img class="swiper-slide myBtn4" src="images/movie4.png" alt="movie3">
